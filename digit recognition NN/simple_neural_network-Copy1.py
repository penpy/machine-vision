...
""" 
Neural network with 1 hidden layer for handwritten digit recognition
===========
PRESENTATION
...
The MNIST dataset of 60000 handwritten digits is used to train the network.
10000 MNIST handwritten digits are used to test the network.
...
This is a forward propagating network with 3 layers :
    ...
    - the hidden layer has 16 nodes (This number can be modified as wished)
...
w1 : weight matrice 1 (between x and h)
w2 : weight matrice 2 (between ha and y)
b1 : bias vectors 1 (between x and h)
b2 : bias vectors 2 (between ha and y)
...
batch_size : number of training images used per batch
...
# =====================
# Collecting the MNIST database of handwritten digits
# =====================
...
# Number of Python project 1 images used to calculate the accuracy
n_tests = 500
...
def test():
    # Takes one random image from the Python project 1 dataset and checks if the
